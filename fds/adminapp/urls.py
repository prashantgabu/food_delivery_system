...
urlpatterns = [
    ...
    path('a_verifyRestaurant/<int:id>', views.a_verifyRestaurant, name='a_verifyRestaurant'),
    path('a_rejectRestaurant/<int:id>', views.a_rejectRestaurant, name='a_rejectRestaurant'),
    path('a_blockRestaurant/<int:id>', views.a_blockRestaurant, name='a_blockRestaurant'),
