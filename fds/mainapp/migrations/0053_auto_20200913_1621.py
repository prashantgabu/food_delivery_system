...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0052_auto_20200913_1618'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='cart',
            name='discount_id',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='mainapp.Discount'),
        ),
        migrations.AlterField(
            model_name='cart',
            name='dish_id',
